...
import me.youm.plumblossom.ui.clickgui.classic.ui.PlumThemeLeft
import me.youm.plumblossom.ui.clickgui.classic.ui.PlumThemeRight
...
class ClassicScreen : Screen(Text.translatable("classic")) , IComponent{
    ...
    override fun render(matrices: MatrixStack?, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        RenderUtil.drawColumnGradientRect(matrices,xPos,yPos,10,10, PlumThemeLeft, PlumThemeRight)
    }
